            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body more-items loading-more-container">
                                <button type="button" class="btn  btn-info footable-show">Loading More</button>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-8 p-t-10 p-b-20 align-self-center">
                                        <div class="usage chartist-chart" style="height:60px"><div class="chartist-tooltip" style="top: 10px; left: 68.125px;"></div><svg xmlns:ct="http://gionkunz.github.com/chartist-js/ct" width="100%" height="100%" class="ct-chart-line" style="width: 100%; height: 100%;"><g class="ct-grids"></g><g><g class="ct-series ct-series-a"><path d="M30,55L30,35C38.989,41.667,47.978,55,56.967,55C65.955,55,74.944,7,83.933,7C92.922,7,101.911,51,110.9,51C119.888,51,128.877,23,137.866,23C146.855,23,155.844,43,164.833,43C173.821,43,182.81,13,191.799,7C200.788,1,209.777,-1,218.766,-5L218.766,55Z" class="ct-area"></path><path d="M30,35C38.989,41.667,47.978,55,56.967,55C65.955,55,74.944,7,83.933,7C92.922,7,101.911,51,110.9,51C119.888,51,128.877,23,137.866,23C146.855,23,155.844,43,164.833,43C173.821,43,182.81,13,191.799,7C200.788,1,209.777,-1,218.766,-5" class="ct-line"></path><line x1="30" y1="35" x2="30.01" y2="35" class="ct-point" ct:value="5"></line><line x1="56.96651785714286" y1="55" x2="56.97651785714286" y2="55" class="ct-point" ct:value="0"></line><line x1="83.93303571428572" y1="7" x2="83.94303571428573" y2="7" class="ct-point" ct:value="12"></line><line x1="110.89955357142857" y1="51" x2="110.90955357142857" y2="51" class="ct-point" ct:value="1"></line><line x1="137.86607142857144" y1="23" x2="137.87607142857144" y2="23" class="ct-point" ct:value="8"></line><line x1="164.83258928571428" y1="43" x2="164.84258928571427" y2="43" class="ct-point" ct:value="3"></line><line x1="191.79910714285714" y1="7" x2="191.80910714285713" y2="7" class="ct-point" ct:value="12"></line><line x1="218.765625" y1="-5" x2="218.775625" y2="-5" class="ct-point" ct:value="15"></line></g></g><g class="ct-labels"></g></svg></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-8 p-t-10 p-b-20 text-right">
                                        <div class="spark-count" style="height:60px"><canvas width="146" height="70" style="display: inline-block; width: 146px; height: 70px; vertical-align: top;"></canvas></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <!-- Column -->
                        <div class="card">
                            <img class="card-img-top" src="/admin/img/background/profile-bg.jpg" alt="Card image cap">
                            <div class="card-block little-profile text-center">
                                <div class="pro-img"><img src="/admin/img/users/4.jpg" alt="user" /></div>
                            ...
                            <div class="card-block">
                                <div class="message-box contact-box">
                                    ...
                                    <div class="message-widget contact-widget">
                                        <!-- Message -->
                                        <a href="#">
                                            <div class="user-img"> <img src="/admin/img/users/1.jpg" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                            <div class="mail-contnet">
                                                <h5>Pavan kumar</h5> <span class="mail-desc">info@wrappixel.com</span></div>
                                        </a>
                                        <!-- Message -->
                                        <a href="#">
                                            <div class="user-img"> <img src="/admin/img/users/2.jpg" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
                                            <div class="mail-contnet">
                                                <h5>Sonu Nigam</h5> <span class="mail-desc">pamela1987@gmail.com</span></div>
                                        </a>
                                        <!-- Message -->
                                        ...
                                        <!-- Message -->
                                        <a href="#">
                                            <div class="user-img"> <img src="/admin/img/users/4.jpg" alt="user" class="img-circle"> <span class="profile-status offline pull-right"></span> </div>
                                            <div class="mail-contnet">
                                                <h5>Pavan kumar</h5> <span class="mail-desc">kat@gmail.com</span></div>
                                        </a>
                                    </div>
                                ...
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="card-block">
                                        <div class="profiletimeline">
                                            ...
                                            <div class="sl-item">
                                                <div class="sl-left"> <img src="/admin/img/users/1.jpg" alt="user" class="img-circle"> </div>
                                                <div class="sl-right">
                                                    <div><a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                                        <p>assign a new task <a href="#"> Design weblayout</a></p>
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="/admin/img/big/img1.jpg" alt="user" class="img-responsive radius"></div>
                                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="/admin/img/big/img2.jpg" alt="user" class="img-responsive radius"></div>
                                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="/admin/img/big/img3.jpg" alt="user" class="img-responsive radius"></div>
                                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="/admin/img/big/img4.jpg" alt="user" class="img-responsive radius"></div>
                                                        </div>
                                            ...
                                            <hr>
                                            <div class="sl-item">
                                                <div class="sl-left"> <img src="/admin/img/users/2.jpg" alt="user" class="img-circle"> </div>
                                                <div class="sl-right">
                                                    <div> <a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                                        <div class="m-t-20 row">
                                                            <div class="col-md-3 col-xs-12"><img src="/admin/img/big/img1.jpg" alt="user" class="img-responsive radius"></div>
                                            ...
                                            <hr>
                                            <div class="sl-item">
                                                <div class="sl-left"> <img src="/admin/img/users/3.jpg" alt="user" class="img-circle"> </div>
                                                <div class="sl-right">
                                                    <div><a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                            ...
                                            <hr>
                                            <div class="sl-item">
                                                <div class="sl-left"> <img src="/admin/img/users/4.jpg" alt="user" class="img-circle"> </div>
                                                <div class="sl-right">
                                                    <div><a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
