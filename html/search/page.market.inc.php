                            ...
                            <div class="standard-page tabs-content bordered">
                                <div class="tab-container">
                                    <nav class="tabs">
                                        ...
                                        <a href="/search/market"><span class="tab active"><?php echo $LANG['page-market']; ?></span></a>
                                    </nav>
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button onclick="Market.newItem()" type="button" class="btn btn-primary"><?php echo $LANG['action-post']; ?></button>
                </div>
            </div>
        </div>
    </div>
