...

{
...

    {
        ...
        $sql = "SELECT count(*) FROM users WHERE state = 0 AND account_type = 0 AND (login LIKE '{$queryText}' OR fullname LIKE '{$queryText}' OR email LIKE '{$queryText}' OR country LIKE '{$queryText}' OR mela LIKE '{$queryText}')".$genderSql.$onlineSql.$photoSql;
...

    {
        ...
        $sql = "SELECT id, regtime FROM users WHERE state = 0 AND account_type = 0 AND (login LIKE '{$queryText}' OR fullname LIKE '{$queryText}' OR email LIKE '{$queryText}' OR country LIKE '{$queryText}') ".$genderSql.$onlineSql.$photoSql.$endSql;
     ...
     public function artist_query($queryText = '', $userId = 0, $gender = -1, $online = -1, $photo = -1)

    {
        ...
        $sql = "SELECT id, regtime FROM users WHERE artist='Yes' AND (login LIKE '{$queryText}' OR fullname LIKE '{$queryText}' OR email LIKE '{$queryText}' OR country LIKE '{$queryText}' OR mela LIKE '{$queryText}') ".$genderSql.$onlineSql.$photoSql.$endSql;
...

    {
       ...
       // $sql = "SELECT id, regtime FROM users WHERE state = 0 AND account_type = 0 AND id < {$itemId}".$genderSql.$onlineSql.$photoSql.$endSql;
        $sql = "SELECT id, regtime FROM users WHERE state = 0 AND account_type = 0 ".$genderSql.$onlineSql.$photoSql.$endSql;
    ...
    public function artist_preload($itemId = 0, $gender = -1, $online = -1, $photo = -1, $limit = 20)

    {
        ...
        //$sql = "SELECT id, regtime FROM users WHERE state = 0 AND account_type = 0 AND id < {$itemId}".$genderSql.$onlineSql.$photoSql.$endSql;
        $sql = "SELECT id, regtime FROM users WHERE artist='Yes' ".$genderSql.$onlineSql.$photoSql.$endSql;
...
//echo "<pre/>"; print_r($stmt); die;
...

    {
       ...
       // $stmt = $this->db->prepare("SELECT id, regtime FROM users WHERE state = 0 AND account_type > 0 AND id < (:itemId) ORDER BY regtime DESC LIMIT :limit");
        ...
        $stmt = $this->db->prepare("SELECT id, regtime FROM users WHERE state = 0 AND account_type !=0 ORDER BY regtime DESC LIMIT ".$limit."");
...

    {
       ...
       // $stmt = $this->db->prepare("SELECT id, regtime FROM users WHERE state = 0 AND account_type > 0 AND (login LIKE (:query) OR fullname LIKE (:query)) AND id < (:itemId) ORDER BY regtime DESC LIMIT 20");
        ...
        $stmt = $this->db->prepare("SELECT id, regtime FROM users WHERE state = 0 AND account_type > 0 AND (login LIKE (:query) OR fullname LIKE (:query))  ORDER BY regtime DESC LIMIT 20");
