...

{
                                            ...
                                            <div class="input-group input-group-lg input-group-merge">
                                                ...
                                                <div class="input-group-append">
                                                    ...
                                                    <span class="input-group-text border-0 py-0 pl-2 pr-0">
                                                        ...
                                                        <span class="smile-button btn-emoji-picker d-inline-block flat_btn">
                                                ...
                                                <div class="popover top popover-emoji bs-popover-top fade bs-popover-top-right hidden" data-toggle="popover-emoji">

                                                    <div class="arrow" style="right: 82px;"></div>
    ...
    static function artist_peopleItem($profile, $LANG, $helper = null)

    {
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 grid-item mb-3" data-id="<?php echo $profile['id']; ?>>">
        
        <div class="add_friend_body">
        ...
        <div class="col-lg-5 col-md-5 no_padding">
        <div class="profile_name">
        <a href="/<?php echo $profile['username']; ?>" class="photo">
        <h3> <span class="user-badge user-verified-badge mr-1 <?php if (!$profile['verified']) echo 'hidden'; ?>" rel="tooltip" title="<?php echo $LANG['label-account-verified']; ?>"><i class="iconfont icofont-check-alt"></i></span>
              <span class="display-name" title="<?php echo $profile['fullname']; ?>"><?php echo $profile['fullname']; ?></span></h3>
        ...
        <p><?php echo $profile['mela']; ?> ಮೇಳ </p>
            ...
            <!--<div class="card add_friend_body" data-id="14178">
                ...
                <a href="/<?php echo $item['fromUserUsername']; ?>/market/<?php echo $item['id']; ?>">
                    ...
                    <div class="market-item-preview" style="background-image:url(<?php echo $itemPhotoUrl; ?>)">
                        ...
                        <span class="info-badge black">
                            ...
                            <span class="sub-title"><?php echo $item['fromUserFullname']; ?></span>
							<h6 class="mx-2 mt-3" style=""><span class="p-1" style="border-radius: 5px; background-color: #5EBA7D; color: white">Rs <?php echo $item['price']; ?></span></h6>
        ...
        <div class="card " data-id="<?php echo $post['id']; ?>">
            ...
            <li class="custom-list-item post-item" data-id="<?php echo $post['id']; ?>">
                ...
                <div class="item-meta post-item-content">
                    ...
                    <h4 class="mx-2 mt-3" style=""><span class="p-2" style="border-radius: 5px; background-color: #5EBA7D; color: white">Rs <?php echo $post['price']; ?></span></h4>
