<?php
    ...
    $TEXT['page-signup'] = "ಹೊಸ ಅಕೌಂಟ್ ತೆರೆಯಿರಿ ";



    $TEXT['page-login'] = "ಲಾಗಿನ್ ಆಗಿ ";
    ...
    $TEXT['label-mobile-number'] = "ಮೊಬೈಲ್ ನಂಬರ್";
    
    $TEXT['label-mobile-number_old'] = "ಹಳೆ ಮೊಬೈಲ್ ನಂಬರ್";
    $TEXT['label-mobile-number_new'] = "ಹೊಸ ಮೊಬೈಲ್ ನಂಬರ್";

    $TEXT['page-profile-mobile'] = "ಮೊಬೈಲ್ ನಂಬರನು ಬದಲಾಯಿಸಿ ";



    $TEXT['label-fullname'] = "ಪೂರ್ತಿ ಹೆಸರು ";
    ...
    $TEXT['label-password'] = "ಪಾಸ್ವರ್ಡ್ ";

    $TEXT['label-mobile'] = "ಮೊಬೈಲ್";
    ...
    $TEXT['action-add-img'] = "ಚಿತ್ರವನ್ನು ಹಾಕಿ ";



    $TEXT['action-remove-img'] = "ಚಿತ್ರವನ್ನು ತೆಗೆಯಿರಿ";



    $TEXT['action-close'] = "ಮುಚ್ಚಿ ";
...
//    $TEXT['action-join'] = "Регистрация";
    ...
    $TEXT['msg-login-mobile-taken'] = "A user with that mobile number already exists.";
    ...
    $TEXT['msg-mobile-save-error'] = "Mobile not changed, wrong current Mobile.";
    ...
    $TEXT['msg-phone-not-found'] = "User with this mobile number was not found in the database.";



    $TEXT['msg-reset-password-sent'] = "A message with link to reset your password has been sent to your mobile.";
    ...
    $TEXT['action-show-all'] = "ಪೂರ್ತಿ ನೋಡಿ";
    ...
    $TEXT['page-popular'] = "ಜನಪ್ರಿಯ ಸುದ್ದಿ";
    ...
    $TEXT['label-group-search-prompt'] = "ಗ್ರೂಪ್ (ಮೇಳ)ವನ್ನು ಹುಡುಕಿ  .";
    ...
    $TEXT['label-group-date'] = "ಶುರುವಾಗಿದು";
    ...
    $TEXT['label-settings-mobile-sub-title'] = "Change Mobile number.";

    $TEXT['label-settings-deactivation-sub-title'] = "Enter your current password.";


	$TEXT['page-artist'] = "ಕಲಾವಿದರು ";
	$TEXT['page-video'] = "ಯಕ್ಷಗಾನ ವಿಡಿಯೋ ";
	$TEXT['page-event'] = "ಯಕ್ಷಗಾನ ವೇಳಾಪಟ್ಟಿ";
	
    $TEXT['nav-communities'] = "ಯಕ್ಷಗಾನ ಮೇಳಗಳು";

    $TEXT['nav-profile'] = "ಪ್ರೊಫೈಲ್ ";

    $TEXT['nav-friends'] = "ಸ್ನೇಹಿತರು ";

    $TEXT['nav-messages'] = " ಸುದ್ದಿ ";

    $TEXT['nav-notifications'] = "ನೋಟಿಫಿಕೇಷನ್ಸ್ ";

    $TEXT['nav-search'] = "ಹುಡುಕು ";

    $TEXT['nav-settings'] = "ಸೆಟ್ಟಿಂಗ್ಸ್";

    $TEXT['nav-logout'] = "ಲಾಗ್ ಔಟ್ ";

    $TEXT['nav-news'] = "ಯಕ್ಷನೋಟ ಸುದ್ದಿಗಳು  ";



    $TEXT['nav-popular'] = "ಜನಪ್ರಿಯ ಸುದ್ದಿ";

    $TEXT['nav-favorites'] = "ಫೇವರಿಟ್ಸ ";

    $TEXT['nav-guests'] = "ಹೊಸ ಸದಸ್ಯರು ";

    $TEXT['nav-gallery'] = "ಫೋಟೋ ";

    $TEXT['nav-home'] = "ಹಿಂದಿರುಗು ";
    ...
    $TEXT['page-news-description'] = "ಇಲ್ಲಿ ನೀವು ಯಕ್ಷನೋಟ ಸ್ನೇಹಿತರು ಮತ್ತು ಯಕ್ಷಗಾನ ಮೇಳಗಳ ಸಂದೇಶವನ್ನು ನೋಡಬಹುದು!";

    $TEXT['page-stream-description'] = "ಇಲ್ಲಿ ನೀವು ಯಕ್ಷನೋಟ ಸ್ನೇಹಿತರು ಮತ್ತು ಯಕ್ಷಗಾನ ಮೇಳಗಳ ಸಂದೇಶವನ್ನು ನೋಡಬಹುದು!";
    ...
    $TEXT['tab-search-users'] = "ಸದಸ್ಯರು ";

    $TEXT['tab-search-communities'] = "ಮೇಳಗಳು" ;
    ...
    $TEXT['page-market'] = "ಕಲಾವಿದರಿಗೆ ಸಹಾಯ ";

    $TEXT['page-market-sub-title'] = "ಇಲ್ಲಿ ನೀವು ನಿಮ್ಮ ಸಹಾಯದ ಕೋರಿಕೆಯನ್ನ ಸಲ್ಲಿಸಬಹುದು ಜೊತೆಗೆ ಸಹಾಯದ ನಿರೀಕ್ಷೆಯಲ್ಲಿ ಇರುವವರೆಗೆ ಸಹಾಯ ಮಾಡಬಹುದು";
    ...
    $TEXT['market-new-item-dlg-title'] = "ಹೊಸ ಸಹಾಯದ ಕೋರಿಕೆ ಸಲ್ಲಿಸಿ ";

    $TEXT['market-new-item-ad-title'] = "ಸಹಾಯದ ಸಂಕ್ಷಿಪ್ತ ವಿವರಣೆ ";

    $TEXT['market-new-item-ad-title-placeholder'] = "ಸಹಾಯದ ಸಂಕ್ಷಿಪ್ತ ವಿವರಣೆ ಬರೆಯಿರಿ";

    $TEXT['market-new-item-ad-desc'] = "ಸಹಾಯದ  ಸಂಪೂರ್ಣ  ವಿವರಣೆ";

    $TEXT['market-new-item-ad-desc-placeholder'] = "ನಿಮಗೆ ಬೇಕಾಗಿರುವ ಧನ ಸಹಾಯದ ಬಗ್ಗೆ ಸಂಪೂರ್ಣ  ವಿವರಣೆಯ ಜೊತೆಗೆ ಬ್ಯಾಂಕ್ ಖಾತೆಯನ್ನು ನಮೂದಿಸಿರಿ
ಜೊತೆಗೆ ಒಂದು ಒಳ್ಳೆಯ ಚಿತ್ರವನ್ನು ಹಾಕಿ ";

    $TEXT['market-new-item-ad-price'] = "ನಿಮ್ಮ ಬೇಕಾಗಿರುವ ಧನ ಸಹಾಯದ ಮೊತ್ತ ";



    $TEXT['market-new-item-button-title'] = "ಸಹಾಯದ ನಿರೀಕ್ಷೆ ";

    $TEXT['market-new-item-promo-title'] = "ನಿಮ್ಮ ಕೋರಿಕೆಯನ್ನ ಇಲ್ಲಿ ಬರೆಯಿರಿ!";

    $TEXT['market-new-item-promo-desc'] = "ನಿಮಗೆ ಬೇಕಾಗಿರುವ ಧನ ಸಹಾಯದ ಬಗ್ಗೆ ವಿವರಣೆಯನ್ನು ಬರೆಯಿರಿ!";



    $TEXT['action-contact-seller'] = "ಸಹಾಯದ ನಿರೀಕ್ಷೆಯಲ್ಲಿ ಇರುವವರನ್ನು ಸಂಪರ್ಕಿಸಿ ";
